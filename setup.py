...
#The project's main homepage.
    url='https://github.com/sunfounder/bl100-hat',
...
def install():
    ...
    # # Install bl100-hat package
    # # =============================
    # do(msg=f"Install bl100-hat {__version__}",
